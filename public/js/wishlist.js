      ...
      list.get().then(function(snapshop) {
        ...
        TravelList.forEach(function(item) {
          ...
          str +=
            ...
            photo +
            '><i class="far fa-heart like-btn fas" data-tag="travel " id = ' +
            id +
    ...
    .then(function(snapshop) {
      ...
      list.get().then(function(snapshop) {
        ...
        PresentList.forEach(function(item) {
          ...
          str +=
            '<a href="presentPagination.html?id=' +
            id +
            '" class="present-card"><div class="present-img"><img src="' +
            photo +
            '"><i class="far fa-heart like-btn fas" aria-hidden="true" id = ' +
            id +
      ...
      list.get().then(function(snapshop) {
        ...
        FoodList.forEach(function(item) {
          ...
          str +=
            ...
            photo +
            '"><i class="far fa-heart like-btn food-likebtn fas"aria-hidden="true" id="' +
            id +
            '"></i></div></div><food-card-right class="food-card-right"><div class="food-title">' +
            name +
